  ...
  const renderContent = () => {
    switch (type) {
      ...
      case 'fullscreen-image':
        return (
          <div className="w-full max-w-7xl mx-auto px-8">
              ...
              <div className="w-full bg-white border-2 border-dashed border-gray-300 rounded-lg p-8">
                <div className="h-96 flex items-center justify-center bg-gray-50 rounded-lg">
                  <div className="text-center">
                    {content.image_placeholder === 'database-erd' && (
                      <div className="text-6xl text-gray-400 mb-4">🗄️</div>
                    )}
                    {content.image_placeholder === 'architecture-diagram' && (
                      <div className="text-6xl text-gray-400 mb-4">🏗️</div>
                    )}
                    {content.image_placeholder === 'admin-interface' && (
                      <div className="text-6xl text-gray-400 mb-4">⚙️</div>
                    )}
                    {content.image_placeholder === 'storefront' && (
                      <div className="text-6xl text-gray-400 mb-4">🛍️</div>
                    )}
                    <div className="text-gray-400 mb-4">{content.description}</div>
      ...
      case 'migration-story':
        return (
          <div className="max-w-7xl mx-auto space-y-8">
            {/* Migration Process Screenshot Placeholder */}
            <div className="mb-12">
              <div className="bg-white border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                <div className="h-48 flex items-center justify-center bg-gray-50 rounded-lg mb-4">
                  <div className="text-center">
                    <div className="text-4xl text-gray-400 mb-2">🚀➡️☁️</div>
                    <div className="text-gray-500 font-medium text-lg">Database Migration Process</div>
                    <div className="text-sm text-gray-400">SQL dump and migration screenshots</div>
                  </div>
                </div>
              </div>
            </div>
