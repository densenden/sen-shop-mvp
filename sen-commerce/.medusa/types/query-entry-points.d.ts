...
export type Artwork = {
  ...
  artwork_collection_id: Maybe<Scalars['String']['output']>;
  product_ids: Maybe<Scalars['JSON']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
...
export type ArtworkCollection = {
  __typename?: 'ArtworkCollection';
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  description: Maybe<Scalars['String']['output']>;
  topic: Maybe<Scalars['String']['output']>;
  month_created: Maybe<Scalars['String']['output']>;
  midjourney_version: Maybe<Scalars['String']['output']>;
  purpose: Maybe<Scalars['String']['output']>;
  thumbnail_url: Maybe<Scalars['String']['output']>;
  editorial_image_1: Maybe<Scalars['String']['output']>;
  editorial_image_2: Maybe<Scalars['String']['output']>;
  editorial_image_3: Maybe<Scalars['String']['output']>;
  editorial_image_4: Maybe<Scalars['String']['output']>;
  brand_story: Maybe<Scalars['String']['output']>;
  genesis_story: Maybe<Scalars['String']['output']>;
  design_philosophy: Maybe<Scalars['String']['output']>;
  core_values: Maybe<Scalars['JSON']['output']>;
  visual_themes: Maybe<Scalars['JSON']['output']>;
  lifestyle_concepts: Maybe<Scalars['JSON']['output']>;
  campaign_ideas: Maybe<Scalars['JSON']['output']>;
  target_audience_messaging: Maybe<Scalars['String']['output']>;
  brand_tagline: Maybe<Scalars['String']['output']>;
  brand_colors: Maybe<Scalars['JSON']['output']>;
  brand_fonts: Maybe<Scalars['JSON']['output']>;
  social_media_tags: Maybe<Scalars['JSON']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
...
export type DigitalProductDownload = {
  __typename?: 'DigitalProductDownload';
  id: Scalars['ID']['output'];
  digital_product_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  customer_id: Scalars['String']['output'];
  token: Scalars['String']['output'];
  download_count: Scalars['Int']['output'];
  last_downloaded_at: Maybe<Scalars['DateTime']['output']>;
  expires_at: Maybe<Scalars['DateTime']['output']>;
  is_active: Scalars['Boolean']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
