...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
  try {
    ...
    const productIds: string[] = Array.isArray(artwork.product_ids) ? artwork.product_ids : []
    ...
    const updated = await (artworkService as any).updateArtworks({ id: artwork_id, ...updateData })
