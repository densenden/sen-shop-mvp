    ...
    <Section className="bg-gray-100 px-6 py-4">
      ...
      <Row className="mb-3">
        <Column className="w-10">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 521.6 517.4" width="32" height="32" style={{ width: '32px', height: '32px', fill: '#9ca3af' }}>
        ...
        <Column className="align-middle">
          <Text className="text-xs font-medium text-gray-500 m-0 ml-2" style={{ fontFamily: 'Inter, sans-serif' }}>SEN.CO UG</Text>
        </Column>
      </Row>
      
      {/* Company Information */}
      <Section className="text-center">
        <Text className="text-xs text-gray-400 leading-tight m-0 mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>
          Paradiesgasse 53, 60594 Frankfurt am Main, Germany
        </Text>
        
        <Text className="text-xs text-gray-400 leading-tight m-0 mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>
          <Link href="mailto:shop@sen.studio" className="text-gray-400 no-underline">shop@sen.studio</Link> • 
          <Link href="https://shop.sen.studio" target="_blank" rel="noopener noreferrer" className="text-gray-400 no-underline">shop.sen.studio</Link>
        </Text>
        ...
        <Text className="text-xs text-gray-400 leading-tight m-0" style={{ fontFamily: 'Inter, sans-serif' }}>
          <Link href="https://www.sen.studio/content/legal/imprint.html" target="_blank" rel="noopener noreferrer" className="text-gray-400 no-underline">Legal</Link> • 
          <Link href="https://www.sen.studio/content/legal/privacy.html" target="_blank" rel="noopener noreferrer" className="text-gray-400 no-underline">Privacy</Link> • 
          <Link href="https://www.sen.studio/content/legal/terms.html" target="_blank" rel="noopener noreferrer" className="text-gray-400 no-underline">Terms</Link>
        </Text>
      </Section>
    </Section>
  </Section>
