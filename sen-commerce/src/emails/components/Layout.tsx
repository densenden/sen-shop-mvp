import { Html, Head, Font, Preview, Body, Container, Section, Text, Hr, Link, Heading, Row, Column, Tailwind } from '@react-email/components'
    ...
    <Head>
      ...
      <style>{`
        * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif !important; }
        body { font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif !important; }
      `}</style>
    </Head>
    <Preview>{preview}</Preview>
    <Tailwind>
      <Body className="bg-gray-50 font-sans m-0 p-0" style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
        <Container className="max-w-2xl mx-auto my-8 bg-white shadow-lg rounded-lg overflow-hidden">
          {/* Header with Logo */}
          <Section className="bg-white px-8 py-6 border-b border-gray-100">
            <Row>
              <Column className="w-16">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 521.6 517.4" width="50" height="50" style={{ width: '50px', height: '50px', fill: '#111827' }}>
              ...
              <Column className="align-middle">
                <Heading className="text-gray-900 text-2xl font-semibold m-0 ml-3" style={{ fontFamily: 'Inter, sans-serif' }}>SenCommerce</Heading>
                <Text className="text-gray-500 text-sm m-0 ml-3" style={{ fontFamily: 'Inter, sans-serif' }}>Digital Art & Print-on-Demand</Text>
              </Column>
            </Row>
          </Section>
