...
<body style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background-color: #ffffff; margin: 0; padding: 0; line-height: 1.6; color: #374151;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="text-align: center; margin-bottom: 60px;">
      <img src="${logoSvgDataUrl}" alt="SenCommerce" style="width: 32px; height: 32px; margin: 0 auto 20px auto; display: block;" />
      <h1 style="color: #1f2937; font-size: 24px; font-weight: 400; margin: 0; font-family: 'Inter', sans-serif;">Order Confirmed</h1>
    </div>
    ...
    <!-- CTA -->
    <div style="text-align: center; margin: 60px 0 40px 0;">
      <a href="https://shop.sen.studio/orders/#SC-2024-TEST" style="background-color: #000000; color: #ffffff; padding: 16px 32px; text-decoration: none; font-weight: 500; font-family: 'Inter', sans-serif; display: inline-block;">Track Your Order</a>
    </div>
...
<body style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background-color: #ffffff; margin: 0; padding: 0; line-height: 1.6; color: #374151;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="text-align: center; margin-bottom: 60px;">
      <img src="${logoSvgDataUrl}" alt="SenCommerce" style="width: 32px; height: 32px; margin: 0 auto 20px auto; display: block;" />
      <h1 style="color: #1f2937; font-size: 24px; font-weight: 400; margin: 0; font-family: 'Inter', sans-serif;">Payment Confirmed</h1>
    </div>
    
    <!-- Content -->
    <div style="margin-bottom: 40px;">
      <p style="color: #374151; margin: 0 0 20px 0; font-family: 'Inter', sans-serif;">Hi Denis Kreuzer,</p>
      <p style="color: #374151; margin: 0 0 30px 0; font-family: 'Inter', sans-serif;">Great news! We've successfully processed your payment for order #SC-2024-TEST.</p>
      ...
      <p style="color: #374151; margin: 5px 0; font-family: 'Inter', sans-serif;"><strong>Order Number:</strong> #SC-2024-TEST</p>
      <p style="color: #374151; margin: 5px 0; font-family: 'Inter', sans-serif;"><strong>Payment Amount:</strong> $29.99 USD</p>
    ...
    <!-- CTA -->
    <div style="text-align: center; margin: 60px 0 40px 0;">
      <a href="https://shop.sen.studio/account/orders/order_test_123" style="background-color: #000000; color: #ffffff; padding: 16px 32px; text-decoration: none; font-weight: 500; font-family: 'Inter', sans-serif; display: inline-block;">View Order Details</a>
    </div>
...
<body style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background-color: #ffffff; margin: 0; padding: 0; line-height: 1.6; color: #374151;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="text-align: center; margin-bottom: 60px;">
      <img src="${logoSvgDataUrl}" alt="SenCommerce" style="width: 32px; height: 32px; margin: 0 auto 20px auto; display: block;" />
      <h1 style="color: #1f2937; font-size: 24px; font-weight: 400; margin: 0; font-family: 'Inter', sans-serif;">Digital Downloads Ready</h1>
    </div>
    
    <!-- Content -->
    <div style="margin-bottom: 40px;">
      <p style="color: #374151; margin: 0 0 20px 0; font-family: 'Inter', sans-serif;">Hi Denis Kreuzer,</p>
      <p style="color: #374151; margin: 0 0 30px 0; font-family: 'Inter', sans-serif;">Great news! Your digital products from order <strong>#SC-2024-TEST</strong> are now ready for download.</p>
      ...
      <div style="margin-bottom: 25px;">
        ...
        <a href="https://shop.sen.studio/downloads/secure-token-123" style="background-color: #000000; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: 500; font-family: 'Inter', sans-serif; display: inline-block;">Download Now</a>
      </div>
      
      <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 25px 0;">
      
      <div style="margin-bottom: 25px;">
        <p style="color: #374151; font-weight: 500; margin: 0 0 5px 0; font-family: 'Inter', sans-serif;">Digital Wallpaper Collection</p>
        <p style="color: #6b7280; font-size: 14px; margin: 0 0 15px 0; font-family: 'Inter', sans-serif;">Expires: ${new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toLocaleDateString()}</p>
        <a href="https://shop.sen.studio/downloads/secure-token-456" style="background-color: #000000; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: 500; font-family: 'Inter', sans-serif; display: inline-block;">Download Now</a>
      </div>
...
async function sendTestEmails() {
  ...
  try {
    console.log('🚀 Starting minimalist email tests...\n');
    ...
    await resend.emails.send({
      ...
      to: testRecipient,
      subject: '[MINIMAL] Welcome to SenCommerce, Denis!',
      html: welcomeHtml
    });
    ...
    await resend.emails.send({
      from: 'SenCommerce <shop@sen.studio>',
      to: testRecipient,
      subject: '[MINIMAL] Payment Confirmed - Order #SC-2024-TEST',
    ...
    await resend.emails.send({
      from: 'SenCommerce <shop@sen.studio>',
      to: testRecipient,
      subject: '[MINIMAL] Order Confirmation #SC-2024-TEST',
    ...
    await resend.emails.send({
      from: 'SenCommerce <shop@sen.studio>',
      to: testRecipient,
      subject: '[MINIMAL] Your Digital Downloads Are Ready - #SC-2024-TEST',
      html: digitalDownloadHtml
    });
    console.log('✅ Digital Download Email sent\n');

    console.log('🎉 All minimalist test emails sent successfully!');
