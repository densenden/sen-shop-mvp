-- Create a complete test order with digital download
...
-- Create order item linking with all required fields
INSERT INTO order_item (
  ...
  'oi_digital_test_complete',
  'order_digital_test_complete',
  1,
  'oli_digital_test_complete',
  1,
  '{"value": "1", "precision": 20}',
  1, -- Mark as fulfilled since it's digital
  '{"value": "1", "precision": 20}',
  0,
...
WHERE o.id = 'order_digital_test_complete';